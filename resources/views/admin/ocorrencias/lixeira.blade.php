...
@section('title', 'Gerenciar Ocorrências Lixeira')

@section('content_header')
<div class="row mb-2">
    <div class="col-sm-6">
        <h2><i class="fas fa-search mr-2"></i> Ocorrências {{(!empty($empresa) ? $empresa->alias_name : '')}} - Lixeira</h2>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">                    
            ...
            @endif
            <li class="breadcrumb-item active">Gerenciar Ocorrências Lixeira</li>
        </ol>
    </div>
</div>
@stop
                ...
                <table id="example1" class="table table-bordered table-striped projects">
                    ...
                    <tbody> 
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Restaurar" href="{{route('ocorrencia.view', [ 'ocorrencia' => $ocorrencia->id ])}}" class="btn btn-xs btn-info text-white" >Restaurar e visualizar</a>
